...
public class ArrayListIntro {
  public static void main(String[] args) {
    ...
    arr.add(3, "Jarvis"); // adds value into that slot, others shift right
    showList(arr);

    int i = arr.indexOf("Hulk");
    System.out.println(arr.get(i) + " is located in slot " + i);
    arr.remove(i); // removes value in that slot, others shift left
    showList(arr);

    arr.add(1, "Captain America"); // original slow 1 and other shift right
    showList(arr);
